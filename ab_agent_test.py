...
class ABIsolationTest(unittest.TestCase):
	...
	def setUp(self):
		reload(game_agent)
		self.player1 = game_agent.AlphaBetaPlayer(search_depth = 5,score_fn=game_agent. custom_score_2)
		self.player1.itrdeep = 0
		self.player2 = game_agent.AlphaBetaPlayer(search_depth = 5,score_fn=game_agent.custom_score_2)
